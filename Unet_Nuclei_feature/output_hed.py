...
def divide_batch(l, n): 
    for i in range(0, l.shape[0], n):  
        yield l[i:i + n,::] 
#basepath ='C:/Users/USUARIO/AppData/Local/Programs/Python/Python36/Phenotype/Unet_nuclei'
def unet_nuclei_hed(indice_slide):
    suffix = str(indice_slide).zfill(3)
    print(suffix)
    basepath ='C:/Users/Laura/AppData/Local/Programs/Python/Python36/Phenotype/Output/output_hem_tiles'
...
#parser.add_argument('-o', '--outdir', help="outputdir, default ./output_hed/001", default="./output/", type=str)
#parser.add_argument('-r', '--resize', help="resize factor 1=1x, 2=2x, .5 = .5x", default=1, type=float)
    parser.add_argument('-m', '--model', help="model", default="epi_unet_best_model_hed.pth", type=str)
 ...
 #   parser.error('No images selected with input pattern')
    ...
    OUTPUT_DIR_ = 'C:/Users/Laura/AppData/Local/Programs/Python/Python36/Phenotype/Output/output_hem'
#resize = args.resize
